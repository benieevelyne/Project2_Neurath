                ...
                for (var i = 0; i < entities.length; i++) {
                    ...
                    if ( entity.properties.TraffickingStats._value == "None") {
                        ...
                        entity.polygon.extrudedHeight =
                            entity.properties.TraffickingStats._value.Total * 10000;
                        objColor = entity.properties.color._value;
                        entity.polygon.material = 
                            Cesium.Color.fromCssColorString(
                            objColor).withAlpha(0.5);
                    ...
                    if (entity.properties.arrowPath._value.length != 0) {
                        ...
                        for (var n = 0; n < (
                            entity.properties.arrowPath._value.length / 4);
                         n++) {
...
viewer.camera.flyTo({
    ...
    orientation : {
        right: new Cesium.Cartesian3(-0.47934589305293746,
             -0.8553216253114552, 0.1966022179118339),
        roll : 0.0
    }
});
